...
@section('content')
    <div class="container bootstrap snippet">
        <div class="row">
            ...
            <div class="col-sm-2"><a href="{{route('admin.menu')}}" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="http://www.gravatar.com/avatar/28fd20ccec6865e2d5f0e1f4446eb7bf?s=100"></a></div>
        </div>
        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="full_name"
                                           placeholder="Full name" value="{{ old('full_name', $profiles->full_name) }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12">
